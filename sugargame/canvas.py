...
class PygameCanvas(Gtk.EventBox):
    def __init__(self, activity, pointer_hint=True, main=None, modules=[pygame]):
        ...
        self.show_all()
        logging.error('PygameCanvas.__init__ ends')

    def run_pygame(self, main, modules=[pygame]):
        """ optional """
        self._main = main
        self._modules = modules
        logging.error('PygameCanvas.run_pygame ends')

    def _realize_cb(self, widget):

        logging.error('PygameCanvas._realize_cb')
        ...
        logging.error('PygameCanvas._realize_cb ends')
